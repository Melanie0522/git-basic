...
## Mel's answer
1.'add' add file into staged area
2.'commit' commit the changes in staged area to local repository
3.'push' push the changes from local repository to remote service